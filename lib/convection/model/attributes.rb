module Convection
  module Model
    ...
    class Attributes
      ...
      def get(stack, key, default = false)
        fail ArgumentError, "Attempted to reference an undefined attribute, #{key}, in stack #{stack} ", caller unless include?(stack, key) || default != false
